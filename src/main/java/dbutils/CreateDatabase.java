...
public class CreateDatabase {
	...
	public void createADSRentDerbyDB() throws FileNotFoundException, IOException, SQLException, PersistenceException {
		DataSource.INSTANCE.connect("jdbc:derby:data/derby/adsdb;create=true", "RentSys", "");
		RunSQLScript.runScript(DataSource.INSTANCE.getConnection(), "data/scripts/createDDL-Rent-Derby.sql");
		RunSQLScript.runScript(DataSource.INSTANCE.getConnection(), "data/scripts/populateTables-Rent-Derby.sql");
		DataSource.INSTANCE.close();		
	}
...
//		new CreateDatabase().createADSDerbyDB();
		new CreateDatabase().createADSRentDerbyDB();
	}
